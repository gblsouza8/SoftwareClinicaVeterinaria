...
tk.Label(frame_cliente, text="CPF do Cliente (11 dígitos):").pack(pady=(10, 0))
entry_cpf_cliente = tk.Entry(frame_cliente, width=20)
entry_cpf_cliente.pack(pady=5, padx=10)

tk.Label(frame_cliente, text="Nome:").pack()
entry_nome_cliente = tk.Entry(frame_cliente, width=20)
entry_nome_cliente.pack(pady=5, padx=10)

tk.Label(frame_cliente, text="Endereço:").pack()
entry_endereco = tk.Entry(frame_cliente, width=20)
entry_endereco.pack(pady=5, padx=10)

tk.Label(frame_cliente, text="Telefone:").pack()
entry_telefone = tk.Entry(frame_cliente, width=20)
entry_telefone.pack(pady=5, padx=10)

tk.Label(frame_cliente, text="Email:").pack()
entry_email = tk.Entry(frame_cliente, width=20)
entry_email.pack(pady=5, padx=10)

btn_cadastrar_cliente = ttk.Button(frame_cliente, text="Cadastrar Cliente", command=cadastrar_cliente)
...
tk.Label(frame_pet, text="Selecione Cliente:").pack(pady=(10, 0))
combo_clientes = ttk.Combobox(frame_pet, state="readonly")
combo_clientes.pack(pady=5, padx=10)

tk.Label(frame_pet, text="Nome do Pet:").pack()
entry_nome_pet = tk.Entry(frame_pet, width=20)
entry_nome_pet.pack(pady=5, padx=10)

tk.Label(frame_pet, text="Espécie:").pack()
entry_especie_pet = tk.Entry(frame_pet, width=20)
entry_especie_pet.pack(pady=5, padx=10)

tk.Label(frame_pet, text="Data de Nascimento (dd/mm/aaaa):").pack()
entry_nascimento_pet = tk.Entry(frame_pet, width=20)
entry_nascimento_pet.pack(pady=5, padx=10)

btn_cadastrar_pet = ttk.Button(frame_pet, text="Cadastrar Pet", command=cadastrar_pet)
btn_cadastrar_pet.pack(pady=10)

# Aba Consultas
frame_consulta = ttk.Frame(notebook)
notebook.add(frame_consulta, text="Consultas")

tk.Label(frame_consulta, text="Selecione Cliente:").pack(pady=(10, 0))
combo_clientes_consulta = ttk.Combobox(frame_consulta, state="readonly")
combo_clientes_consulta.pack(pady=5, padx=10)
...
combo_pets_consulta.pack(pady=5, padx=10)
...
combo_especialidade.pack(pady=5, padx=10)
combo_especialidade.bind("<<ComboboxSelected>>", atualizar_profissional)

tk.Label(frame_consulta, text="Profissional:").pack()
entry_profissional = tk.Entry(frame_consulta, width=20, state='readonly')
entry_profissional.pack(pady=5, padx=10)

tk.Label(frame_consulta, text="Motivo da Consulta:").pack()
entry_motivo_consulta = tk.Entry(frame_consulta, width=20)
entry_motivo_consulta.pack(pady=5, padx=10)
...
listbox_listagem.pack(pady=10, padx=10, fill='both', expand=True)
